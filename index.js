...
await ctx.replyWithHTML('<b>Курсы</b>', Markup.inlineKeyboard(
    [
        [Markup.button.callback('Редактрок', 'btn_1'), Markup.button.callback('Редактрок', 'btn_2'), Markup.button.callback('Редактрок', 'btn_3')]
    ]
))
    } catch(e) {
        console.error(e) // Отлаавитель ошибок
    }
})
